...
const CURRENT: ReleaseContent = {
  ...
  highlights: [
    {
      icon: I.sparkle,
      title: "Real noise suppression in front of the speech engine",
      body: "Studio-grade RNNoise filter runs before transcription. Cuts hum, fans, congregation noise; voice stays clean. On by default.",
    },
    {
      icon: I.sparkle,
      title: "Import lyrics from PDF, Word, or PowerPoint",
      body: "Drop a .pdf, .docx, or .pptx into the library — ACE extracts the text and auto-splits it into verses and choruses. Joins the existing .txt / ChordPro / ProPresenter / OpenLyrics support.",
    },
    {
      icon: I.sparkle,
      title: "Auto-switches to multilingual when English isn't being sung",
      body: "If the online speech engine stops hearing English but audio is clearly present, ACE switches itself to multilingual mode and reconnects. No setting flip required.",
    },
    {
      icon: I.bug,
      title: "Online engine drops mid-service → offline takes over automatically",
      body: "When the cloud transcription engine disconnects, ACE flips to the on-device engine within a second. No more silent dead air.",
    },
    {
      icon: I.sparkle,
      title: "Bible paraphrases follow the operator's lead",
      body: "After you display a verse, paraphrases in the same book auto-display for the next 60 seconds — even without an explicit \"the Bible says…\" cue.",
    },
    {
      icon: I.bug,
      title: "Follow-along stays alive when the preacher reads verbatim",
      body: "Reading a verse word-for-word no longer kicks ACE out of follow-along mode.",
    },
  ],
  improvements: [
    "Library list shows the live confidence % for every detected song, with the active one clearly highlighted",
    "Mid-service section edits (add / edit / merge / split / reorder) take effect on the next detection cycle — no restart needed",
    "Manual Bible-verse click no longer drops out of follow-along on the next transcript",
    "Spoken references like \"Matthew 6, verse 17\" now land correctly (comma, period, or dash all accepted between chapter and verse)",
  ],
  fixes: [
    "Online engine could send audio into a dead socket for minutes after a network blip — now fails over within one cycle",
    "Library \"currently listening\" indicator could stay lit on the previous song after a new one was confirmed",
    "Section detection could get stuck on pre-edit lyrics after a mid-service song edit",
    "\"Matthew 6, verse 17\" used to parse as Matthew 6:1 if the preacher paused with a comma",
    "Follow-along could exit mid-verse if the preacher lingered on a verse for too long",
    "Operator-clicked verse could trip a stale miss counter and drop follow-along on the next transcript",
  ],
};
