...
// v1.5.6 — slide-on-HDMI fix (renderer was using file:// which Electron
// blocks cross-origin from app://; now routes through /api/media/file
// which v1.5.6 also extends to search slides/<batch>/), Stage Mirror
...
const FALLBACK: Record<string, string> = {
  "mac-arm64": "ACE-1.5.6-arm64.dmg",
  "mac-x64": "ACE-1.5.6.dmg",
};
