  ...
  return (
    <section className="relative px-6 sm:px-10 pt-20 sm:pt-32 pb-24 text-center overflow-hidden">
      <div
        ...
        style={{
          background: `radial-gradient(70% 50% at 50% 0%, rgba(${ACCENT_RGB},0.30) 0%, rgba(${ACCENT_RGB},0.08) 40%, rgba(${ACCENT_RGB},0) 70%)`,
        }}
      />
      <div className="relative max-w-3xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          <a
            ...
            className="px-7 py-3.5 rounded-full text-white font-bold text-sm transition"
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {features.map((f) => (
            <div
              key={f.title}
              className="p-7 rounded-2xl bg-gradient-to-b from-[#1A1A1A] to-[#111] border border-[#222] flex flex-col gap-3"
            >
  ...
  return (
    <section className="px-6 sm:px-10 py-24 text-center">
      <div className="max-w-2xl mx-auto">
        ...
        <a
          href="mailto:hello@ace-presenter.app?subject=ACE%20Virtual%20World%20early%20access&body=Please%20add%20me%20to%20the%20ACE%20Virtual%20World%20early-access%20list."
          className="inline-block px-7 py-3.5 rounded-full text-white font-bold text-sm transition"
          style={{ background: ACCENT }}
        >
          Register interest →
        </a>
