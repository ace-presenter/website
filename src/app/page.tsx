...
/* ───────────── MANUAL BANNER ─────────────
   Sits between the Nav and the Hero. Bold + brand-red so first-time
   visitors can grab the user manual without hunting through the guide
   route or scrolling. Two formats:
     - HTML (in-browser, searchable)
